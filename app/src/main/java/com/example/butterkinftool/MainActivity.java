...
//        helloWorld2.setText("123");
    ...
    @BindClick({R.id.hello_world_1})
    public void bindClick(View view) {
        Toast.makeText(this, "我是编译期1", Toast.LENGTH_LONG).show();
    }

    @BindClick(R.id.hello_world_2)
    public void bindClick1(View view) {
        Toast.makeText(this, "我是编译期2", Toast.LENGTH_LONG).show();
    }
}
